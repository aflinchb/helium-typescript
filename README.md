...
urlFragment: "/azure-samples/app-service-managed-identity-key-vault-nodejs"
---
...
* TODO: Need to create dir and unit tests
...
# TODO: Re-visit approach w/ env variable
npm run build
...
### TODO: With dockerfile as is, you must specify release target here
az acr build --target=release -r $He_Name -t $He_Name.azurecr.io/helium-node .
...
-i ${He_Name}.azurecr.io/helium-node \
